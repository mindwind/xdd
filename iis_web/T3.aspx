                                ...
                                <td align="center" bgcolor="#FFFFFF"><table width="94%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <table width="94%" border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#ffe7cc" style="line-height:14px; line-height:24px; font-size:14px;">
                                        <tr>
                                          <td width="80" height="30" align="center" bgcolor="#fff6ed"><strong>内部机构</strong></td>
                                          <td align="left" bgcolor="#FFFFFF"><%=Organ %></td>
                                        </tr>
                                        <tr>
                                          <td height="30" align="center" bgcolor="#fff6ed"><strong>办公地址</strong></td>
                                          <td align="left" bgcolor="#FFFFFF"><%=OfficeAddress %></td>
                                        </tr>
                                        <tr>
                                          <td height="30" align="center" bgcolor="#fff6ed"><strong>工作职责</strong></td>
                                          <td align="left" bgcolor="#FFFFFF"><%=Job%></td>
                                        </tr>
                                        <tr>
                                          <td height="30" align="center" bgcolor="#fff6ed"><strong>姓名职务</strong></td>
                                          <td align="left" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DDDDDD">
                                              <tr>
                                                <td width="50%" align="center" background="images/20100729wj_xxgk_19.jpg" class="xxgkH12">职务名称</td>
                                                <td width="50%" height="26" align="center" background="images/20100729wj_xxgk_19.jpg" class="xxgkH12">姓&nbsp;&nbsp;名</td>
                                              </tr>
                                              <%=Name %>
                                          </table></td>
                                        </tr>
                                        <tr>
                                          <td height="30" align="center" bgcolor="#fff6ed"><strong>值班电话</strong></td>
                                          <td align="left" bgcolor="#FFFFFF"><%=Phone %></td>
                                        </tr>
                                        <tr>
                                          <td height="30" align="center" bgcolor="#fff6ed"><strong>传 &nbsp;&nbsp;真</strong></td>
                                          <td align="left" bgcolor="#FFFFFF"><%=Fax %></td>
                                        </tr>
                                        <tr>
                                          <td height="30" align="center" bgcolor="#fff6ed"><strong>投 &nbsp;&nbsp;诉</strong></td>
