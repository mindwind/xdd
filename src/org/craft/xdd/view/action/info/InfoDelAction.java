 ...
 */
public class InfoDelAction extends JsonAction implements SessionAware {
	...
	public InfoDelAction() {
		super();
		log.debug("<action>: invoke default constructor");
	}

	/**
	 * Invoke this while url <code>delInfo.do</code> be requested
	 * 
	 * @return String
	 * @throws Exception
	 *             on any error
