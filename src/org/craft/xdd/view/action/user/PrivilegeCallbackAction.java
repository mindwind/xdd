...
/**
 * Privilege callback action.
 * 
 * @author Frank Hu
 * @version 1.0, 2009-9-10
 */
public class PrivilegeCallbackAction extends JsonAction implements SessionAware {
	...
	public PrivilegeCallbackAction() {
		super();
	...
	public String execute() throws Exception {
		...
		try {
			userService.callbackPrivilege(rid, pid);
